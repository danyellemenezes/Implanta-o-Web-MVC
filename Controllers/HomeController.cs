...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente cliente1 = new Cliente(01, "Diana clementina", "857.032.950-41", "diana.clementina@pe.senai.br", "Luna");
        Cliente cliente2 = new Cliente(02, "William Henry Gates III", "039.618.250-09", "bill@microsoft.com", "Bela");
        Cliente cliente3 = new Cliente(03, "Iris Lovelace", "800.777.920-50", "iris@iris.language.com", "Quiqui");
        Cliente cliente4 = new Cliente(04, "Linus Torvalds", "933.622.400-03", "torvalds@osdl.org", "Nugget");
        Cliente cliente5 = new Cliente(05, "Grace Hopper", "911.702.988-00", "grace.hopper@cobol.com", "Felicia");
      
        //lista de clientese atribui os clientes
